                            ...
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>&nbsp;<img id="valdata" alt="看不清，点击换一张" style="height: 19px" src="ValidateCode/ValidateCode.aspx" onclick="changeSrc(this)" />
                                            <script type="text/javascript">
                                                function changeSrc(id) {
                                                    var time = new Date();
                                                    id.src = "ValidateCode/ValidateCode.aspx?" + time.getMilliseconds();
                                                }
                                            </script>
                                            <span class="required">*</span>
                                        </td>
